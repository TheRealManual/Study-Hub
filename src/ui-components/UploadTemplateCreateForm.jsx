...
export default function UploadTemplateCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setDownloadCount(initialValues.downloadCount);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UploadTemplate(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UploadTemplateCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
