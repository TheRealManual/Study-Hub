...
export default function UserFileCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setOriginalName(initialValues.originalName);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UserFile(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UserFileCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
